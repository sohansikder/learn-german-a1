...
const flashcardData = [
  ...
  },
  {
    ...
    word: "Brot",
    translation: "Bread",
    example: '"Ich esse das Brot zum Frühstück."',
    articleClass: "das",
  },
  {
    article: "der",
  ...
  },
  {
    ...
    word: "Straßenbahn",
    translation: "Tram",
    example: '"Die Straßenbahn fährt zum Hauptbahnhof."',
    articleClass: "die",
  },
  {
    article: "der",
    word: "Fahrschein",
    translation: "Ticket",
    example: '"Ich brauche einen Fahrschein."',
    articleClass: "der",
  },
  {
    article: "die",
...
function prevFlashcard() {
  currentFlashcardIndex =
    (currentFlashcardIndex - 1 + flashcardData.length) % flashcardData.length;
  updateFlashcard();
}
...
const phrasesData = {
  greetings: [
    { german: "Hallo!", english: "Hello!", context: "Informal greeting" },
    {
      ...
      context: "Until about 11 AM",
    },
    {
      german: "Guten Tag!",
      english: "Good day / Hello!",
      context: "Formal, anytime during the day",
    },
    {
      german: "Guten Abend!",
      english: "Good evening!",
      context: "After about 6 PM",
    },
    {
      german: "Gute Nacht!",
      english: "Good night!",
      context: "When saying goodbye at night / bedtime",
    },
    {
      german: "Wie geht es Ihnen?",
      english: "How are you? (formal)",
      context: "With strangers, professors",
    },
    {
      german: "Wie geht's?",
      english: "How's it going?",
      context: "Informal, with friends",
    },
    {
      german: "Mir geht es gut, danke.",
      english: "I'm fine, thank you.",
      context: "Standard response",
    },
    {
      german: "Ich heiße…",
      english: "My name is…",
  ...
  food: [
    ...
    },
    {
      ...
      context: "Asking the waiter",
    },
    {
      german: "Ich bin Vegetarier/Vegetarierin.",
      english: "I am vegetarian. (m/f)",
      context: "Dietary information",
    },
    {
      german: "Guten Appetit!",
      english: "Enjoy your meal!",
      context: "Said before eating",
    },
    {
    ...
    {
      german: "Mit oder ohne Kohlensäure?",
      english: "Sparkling or still?",
      context: "German water question",
    },
    {
      german: "Noch ein Bier, bitte.",
      english: "Another beer, please.",
      context: "At a bar/restaurant",
    },
    {
      german: "Ich nehme das Tagesgericht.",
      english: "I'll take the daily special.",
      context: "At the Mensa/restaurant",
    },
    {
      german: "Haben Sie etwas ohne Gluten?",
      english: "Do you have something gluten-free?",
  ...
  directions: [
    ...
    },
    {
      ...
      context: "At an intersection",
    },
    {
      german: "Es ist in der Nähe.",
      english: "It is nearby.",
      context: "Indicating proximity",
    },
    {
      german: "Wo ist die nächste Haltestelle?",
      english: "Where is the nearest stop?",
      context: "For bus/tram",
    },
    {
      german: "Ich suche die Universität.",
      english: "I'm looking for the university.",
    ...
    {
      german: "Welche Linie fährt zum…?",
      english: "Which line goes to…?",
      context: "Public transport",
    },
    {
      german: "Ich möchte ein Ticket kaufen.",
      english: "I'd like to buy a ticket.",
      context: "At the ticket machine",
    },
    {
      german: "Die erste/zweite Straße links.",
      english: "The first/second street on the left.",
      context: "Giving directions",
    },
  ],
  ...
  shopping: [
    ...
    },
    {
      ...
      context: "Alternative price question",
    },
    {
      german: "Ich möchte das kaufen.",
      english: "I want to buy that.",
      context: "At a shop",
    },
    {
      german: "Haben Sie das in einer anderen Größe?",
      english: "Do you have that in another size?",
      context: "Clothing shopping",
    },
    {
    ...
    {
      german: "Nur Bargeld, bitte.",
      english: "Cash only, please.",
      context: "Many German shops!",
    },
    {
      german: "Wo finde ich…?",
      english: "Where do I find…?",
      context: "In a supermarket",
    },
    {
      german: "Ich brauche eine Tüte.",
      english: "I need a bag.",
      context: "At checkout (bags cost money!)",
    },
    {
      german: "Das ist zu teuer.",
      english: "That is too expensive.",
      context: "Reacting to price",
    },
    {
      german: "Gibt es einen Rabatt?",
      english: "Is there a discount?",
      context: "Asking for deals",
    },
  ],
  ...
  emergency: [
    ...
    },
    {
      ...
      context: "When you didn't catch something",
    },
    {
  ...
  university: [
    {
      ...
      context: "University schedule",
    },
    {
      german: "Wo ist der Hörsaal?",
      english: "Where is the lecture hall?",
      context: "Finding your classroom",
    },
    {
      german: "Ich studiere an der TU Freiberg.",
      english: "I study at TU Freiberg.",
      context: "Introducing your university",
    },
    {
      german: "Was studierst du?",
      english: "What do you study?",
      context: "Common student question",
    },
    {
      german: "Ich studiere Ingenieurwesen.",
      english: "I study engineering.",
      context: "Stating your major",
    },
    {
      german: "Haben Sie die Hausaufgaben?",
      english: "Do you have the homework?",
    ...
    {
      german: "Die Prüfung ist am Montag.",
      english: "The exam is on Monday.",
      context: "Exam schedule",
    },
    {
      german: "Ich brauche eine Verlängerung.",
      english: "I need an extension.",
      context: "For assignments",
    },
    {
      german: "Treffen wir uns in der Mensa?",
      english: "Shall we meet at the cafeteria?",
      context: "Meeting friends for lunch",
    },
  ],
};
...
function initSpeedControl() {
  ...
  const currentRate = parseFloat(
    localStorage.getItem("db_speechRate") || "0.85",
  );
...
function initAutoAudioButtons() {
  ...
  document.querySelectorAll(".grammar-table tbody td").forEach((td) => {
    ...
    if (
      ...
      text.length < 2 ||
      /^[A-Z][a-z]+\.$/.test(text) ||
      /^(Masculine|Feminine|Neuter|Plural|Who|What|Where|When|Why|How|Statement|Time|Yes|W-Question)/.test(
        text,
      )
    )
      return;
    ...
    if (
      /[äöüßÄÖÜ]/.test(text) ||
      /^(der|die|das|ich|du|er|sie|es|wir|ihr|ein|kein|nicht|am|im)\b/i.test(
        text,
      ) ||
      /^[A-Z][a-zäöü]+$/.test(text)
    ) {
...
function initPhraseSearch() {
  ...
  input.addEventListener("input", () => {
    ...
    Object.entries(phrasesData).forEach(([cat, phrases]) => {
      phrases.forEach((p) => {
        if (
          p.german.toLowerCase().includes(query) ||
    ...
    if (allPhrases.length === 0) {
      grid.innerHTML =
        '<div style="text-align:center; padding:40px; color:var(--text-secondary);">No phrases found. Try a different search term.</div>';
      return;
    }
  ...
  const words = [
    {
      ...
      en: "coziness / comfort",
      ex: "Deutsche lieben Gemütlichkeit.",
    },
    {
      de: "der Wanderlust",
      en: "desire to travel",
      ex: "Ich habe Wanderlust.",
    },
    {
      de: "das Fernweh",
      en: "longing for distant places",
      ex: "Ich habe Fernweh.",
    },
    {
      de: "der Schmetterling",
      en: "butterfly",
      ex: "Der Schmetterling ist bunt.",
    },
    {
      de: "die Sehnsucht",
      en: "deep longing",
      ex: "Sehnsucht nach dem Sommer.",
    },
    {
      de: "das Fingerspitzengefühl",
      en: "intuitive finesse",
      ex: "Er hat Fingerspitzengefühl.",
    },
    {
      de: "der Zeitgeist",
      en: "spirit of the times",
      ex: "Das ist der Zeitgeist.",
    },
  ];
...
window.launchApp = function () {
  ...
  if (container) {
    container.outerHTML =
      '<iframe src="../build/web/index.html?v=2" class="app-preview__frame" id="app-iframe"></iframe>';
  }
};
...
/* ═══════════════════════════════════════════════════════════
   GAMIFICATION SYSTEM (Linked to Auth/Cloud Sync)
   ═══════════════════════════════════════════════════════════ */

function getGameState() {
  return JSON.parse(
    localStorage.getItem("db_gameState") || '{"xp":0, "level":1, "streak":0}',
  );
}

function addXP(amount, trainerName = null, stats = null) {
  // If dbSaveXP exists (from auth.js), use it to handle cloud sync
  if (typeof dbSaveXP === "function") {
    dbSaveXP(amount, trainerName, stats);
  } else {
    ...
    localStorage.setItem("db_gameState", JSON.stringify(state));
  }
...
function updateGamificationUI() {
  ...
  // 1. Update floating widget (if present)
  const levelEl = document.getElementById("gw-level");
  if (levelEl) {
    const prevLevel = parseInt(levelEl.textContent.replace("Lv ", "") || "1");
    if (level > prevLevel) {
...
// Called globally by auth.js when auth state changes
...
function loadNextArticleWord() {
  ...
  document.getElementById("at-word-box").className =
    "article-trainer__word-box";
}
...
window.checkArticle = function (selectedArticle) {
  ...
  if (selectedArticle === correctArticle) {
    ...
    // Reset local streak via localStorage directly for simple errors
    const state = getGameState();
    state.streak = 0;
    localStorage.setItem("db_gameState", JSON.stringify(state));
    updateGamificationUI();
...
const sentences = [
  {
    english: "I drink a coffee.",
    words: ["Ich", "trinke", "einen", "Kaffee", "."],
  },
  {
...
function initSentence() {
  ...
  document.getElementById("sb-english").textContent =
    currentSentenceObj.english;
  renderSentenceUI();
}
